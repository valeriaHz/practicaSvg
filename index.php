...
<div class="circulo">
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
            ...
            xml:space="preserve">
            <!-- le da estilo al circulo delimitando el ancho 
                    y el color de la linea, así como el color de relleno 
                    y la cantidad del circulo que resaltara-->
        <style type="text/css">
            .st0 {
                fill: #FFFFFF;
            }
        ...
        <!-- se divide por capas ya que es una imagen vectorial -->
        <g id="Capa_1">
            <g>
                <!-- en la etiqueta a xlink nos permite mostrar el titulo en la parte
                    del circulo que no esta sombreada y el xlink href nos da un link al que nos mandara
                    en este caso se le asigna # ya que no nos mandara a ningun sitio
                    target nos permite redireccionar el link en una pestaña nueva -->
            ...
            <!-- line crea lineas rectas con las coordenadas en (x1,y1) y (x2,y2) -->
        ...
        <g id="Capa_2">
            <!-- crea la linea del circulo -->
            <polyline class="st1" points="1284,483 875.5,483 466.5,479.5 	" />
        </g>
        <g id="Capa_3">
            <!-- xlink permite visualizar el nombre del titulo al poner el cursor 
                sobre esa parte de la imagen -->
